...
- Current [app.tsx](./app.tsx): `3497` lines
- Starting point for this refactor effort: `4632` lines
- Net reduction so far: `1135` lines
...
- Prompt textarea remounts now restore the visible draft and caret position more safely during slash-command typing.

## Notes

- `app.tsx` still owns the main interaction loop, picker state, streaming state, and most keyboard routing.
- The next likely seams are keyboard routing, prompt submission/agent orchestration, transcript rehydration, and entry rendering.
